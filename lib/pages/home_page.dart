...
import 'package:js04/widget/conversion_history.dart';
import 'package:js04/widget/dropdown_conversion.dart';
import 'package:js04/widget/result.dart';
import 'package:js04/widget/user_input.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          const Text('Dea Vernanda R.N',
              style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
          const Text('MI2F/05/2031710084',
              style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
          const SizedBox(
            height: 10,
          ),
